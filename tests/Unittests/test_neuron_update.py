...
class TestNeuronUpdate(unittest.TestCase):
    ...
    def test_single_update_local(self):
        ...
        self.assertTrue(np.allclose(self.net_loc_pop.r, [4.0, 4.0, 4.0]))
    ...
    def test_single_update_global(self):
        ...
        self.assertTrue(np.allclose(self.net_glob_pop.glob_r, [4.0]))
    ...
    def test_single_update_mixed(self):
        ...
        self.assertTrue(np.allclose(self.net_mix_pop.r, [5.0]))
    ...
    def test_bound_update(self):
        ...
        r = self.net_m.get('r')
        self.assertTrue(np.allclose(r[:,0], [1,1,2,3,3]))
