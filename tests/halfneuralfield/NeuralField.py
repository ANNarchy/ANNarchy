...
LeftInput = InputPop[:10, :10]
LeftFocus = FocusPop[:10, :10]
RightInput = InputPop[10:, 10:]
RightFocus = FocusPop[10:, 10:]


# Create the projections
input_focus = Projection( 
    pre = LeftInput, #InputPop, 
    post = LeftFocus, #FocusPop, 
    target = 'exc'
).connect_one_to_one( weights=1.0 )
input_focus2 = Projection( 
    pre = RightInput, #InputPop, 
    post = RightFocus, #FocusPop, 
    target = 'exc'
).connect_one_to_one( weights=1.0 )
