...
#===============================================================================
# testAll2All2 = Projection( 
#     pre = Middle, 
#     post = Out, 
#     target = 'all2',
# ).connect_all_to_all_raw( weights = Uniform(0.2, 0.5), delays = 0.0 )
#===============================================================================
...
#===============================================================================
# visAll2All = Visualization( [ { 'proj': testAll2All2, 'var': 'value', 'min': 0.0, 'max': 1.0, 'title': 'weights all2all'} ] )
# visAll2All.render()
#===============================================================================
