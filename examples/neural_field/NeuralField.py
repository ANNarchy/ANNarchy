...
ReversedSynapse = Synapse( 
    alpha = Variable(eq="dalpha/dt = post.rate - alpha"),
...
Proj1 = Projection( pre = InputPop, post = "Focus", target = 'exc', connector = Connector( type='One2One', weights=RandomDistribution('constant', [1.0]) ) , synapse=ReversedSynapse)
