...
from PyQt4.QtGui import QApplication, QMainWindow, QMessageBox, QTabWidget
...
from ListView import ListView, NeuronListView 
...
#     def _setup_obj(self):
# 
#         self._main_window._ui.neur_general.initialize()
#         self._main_window._ui.neur_general._show_template.connect( self._main_window._ui.objects.set_code )
# 
# 
#         #=======================================================================
...
class EditorMainWindow(QMainWindow):
    ...
    def _set_current_tab(self, idx):
        print self._tab_index, idx
        
        if self._tab_index == 0:
            if self._ui.objects.check_changes():
                reply = QMessageBox.question(self, 'Message', "There are unsaved changes, you want to save?", QMessageBox.Yes, QMessageBox.No)
            
                if reply == QMessageBox.No:
                    self._ui.views.setCurrentIndex(self._tab_index)
                    return
                
                else:
                    self._obj_editor.save()

        self._tab_index = idx
        self._ui.general.setCurrentIndex(idx)
        self._ui.special.setCurrentIndex(idx)
