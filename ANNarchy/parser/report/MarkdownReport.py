...
"""
    for idx, neuron in enumerate(GlobalObjectManager().get_neuron_types()):
        ...
        # Parameters
        parameters = extract_parameters(neuron.parameters, neuron.extra_values, global_keyword='population')
        parameters_list = [
...
"""
    ...
    for idx, synapse in enumerate(GlobalObjectManager().get_synapse_types()):
        ...
        # Parameters
        parameters = extract_parameters(synapse.parameters, synapse.extra_values, global_keyword='projection')
        parameters_list = [
