...
class PAPIProfile(ProfileGenerator):
    ...
    def generate_body_dict(self):
        ...
        """
        body_dict = {
            'prof_include': profile_template['include'],
            'prof_step_pre': profile_template['step_pre'],
            'prof_step_post': profile_template['step_post'],
            'prof_run_pre': profile_template['run_pre'],
            'prof_run_post': profile_template['run_post'],
            'prof_proj_psp_pre': profile_template['proj_psp_pre'],
            'prof_proj_psp_post': profile_template['proj_psp_post'],
            'prof_neur_step_pre': profile_template['neur_step_pre'],
            'prof_neur_step_post': profile_template['neur_step_post']
        }
        return body_dict
