...
{
    ANNARCHY_TRACE_SIM_MSG_MASTER("*** evaluate step " + std::to_string(t) + " ("+std::to_string(t*dt)+" ms) completed ***");
...
%(reset_sums)s
    ...
    ANNARCHY_TRACE_SIM_MSG_MASTER("Update psp/conductances ...");
%(compute_sums)s
...
%(prof_proj_psp_post)s
    ...
    ////////////////////////////////
    ANNARCHY_TRACE_SIM_MSG_MASTER("Record psp/conductances ...");
    ...
    ////////////////////////////////
    ANNARCHY_TRACE_SIM_MSG_MASTER("Draw required random numbers ...");
%(prof_rng_pre)s
...
%(prof_rng_post)s
    ...
    ////////////////////////////////
    ANNARCHY_TRACE_SIM_MSG_MASTER("Evaluate neural ODEs ...");
...
%(prof_neur_step_post)s
    ...
    // Delay outputs
    ////////////////////////////////
    ANNARCHY_TRACE_SIM_MSG_MASTER("Update delay queues ...");
%(delay_code)s

    ////////////////////////////////
    // Global operations (min/max/mean)
    ////////////////////////////////
    ANNARCHY_TRACE_SIM_MSG_MASTER("Update global operations ...");
...
%(prof_global_ops_post)s
    ...
    ////////////////////////////////
    ANNARCHY_TRACE_SIM_MSG_MASTER("Evaluate continous synaptic ODEs ...");
...
%(prof_proj_step_post)s
    ...
    // Postsynaptic events
    ////////////////////////////////
    ANNARCHY_TRACE_SIM_MSG_MASTER("Evaluate post-synaptic events ...");
%(post_event)s
...
%(structural_plasticity)s
    ...
    ////////////////////////////////
    ANNARCHY_TRACE_SIM_MSG_MASTER("Recording state variables ...");
%(prof_record_pre)s
    for (unsigned int i=tid; i < recorders.size(); i += nt){
        if (recorders[i])
            recorders[i]->record();
...
%(prof_step_post)s
    ...
    ANNARCHY_TRACE_SIM_MSG_MASTER("*** simulation step " + std::to_string(t) + " completed ***");
}
