...
from ANNarchy.generator import DendriteTemplates as Templates
from ANNarchy.generator import DendriteTemplatesOMP as OMPTemplates
...
class RateDendriteGenerator(DendriteGenerator):
    ...
    def generate_header(self):
        ...
        # Generate the code
        template = Templates.rate_dendrite_header
        dictionary = { 
