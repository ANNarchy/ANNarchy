...
[FORMAT]_SingleThread:
    ...
    defines the format specific defintions for the currently available formats:
        ...
        * SELLR: sliced ELLPACK format with row-length array
...
from . import SELLR as SELLR_OpenMP
from . import Dense as Dense_OpenMP

__all__ = ["BaseTemplates", "LIL_OpenMP", "LIL_Sliced_OpenMP", "COO_OpenMP", "CSR_OpenMP", "CSR_T_OpenMP", "CSR_T_Sliced_OpenMP", "ELL_OpenMP", "ELLR_OpenMP", "SELLR_OpenMP", "Dense_OpenMP"]