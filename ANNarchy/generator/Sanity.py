...
def _check_storage_formats(projections):
    ...
    for proj in projections:
        ...
        if proj.synapse_type.type == "spike" and proj._storage_format in ["csr_vec", "ell", "ellr", "coo", "hyb", "bsr"]:
        ...
        # For some of the sparse matrix formats we don't implemented plasticity yet.
        if proj.synapse_type.type == "rate" and proj._storage_format in ["coo", "hyb", "bsr"] and not isinstance(proj.synapse_type, DefaultRateCodedSynapse):
